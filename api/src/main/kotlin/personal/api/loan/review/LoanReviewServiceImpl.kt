...
import personal.api.exception.CustomErrorCode
import personal.api.exception.CustomException
import personal.domain.domain.LoanReview
import personal.domain.repository.LoanReviewRepository
import org.springframework.cache.annotation.Cacheable
import org.springframework.stereotype.Service

@Service
class LoanReviewServiceImpl(private val loanReviewRepository: LoanReviewRepository) : LoanReviewService {
    ...
    private fun LoanReview.toResponseDto() =
        LoanReviewDto.
        LoanResult(userLimitAmount = this.loanLimitedAmount, userLoanInterest = this.loanInterest)
